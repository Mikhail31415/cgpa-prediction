...
def get_np_dataset(embedding_threshold, dataset_path):
    train_df, val_df, test_df = pd.read_csv(dataset_path / 'train.csv'), pd.read_csv(dataset_path / 'val.csv'), pd.read_csv(
